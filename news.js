// This is the slug autogenerator, adapted from wolf.js (around line 577) to include support for permalinks
...
document.observe('dom:loaded', function() {
	when('nametoslug', function(nametoslug) {
		...
		new Form.Element.Observer(nametoslug, 0.15, function() {
			...
			if (oldTitle.toSlug() == permalink.value) permalink.value = nametoslug.value.toSlug();
			oldTitle = nametoslug.value;
		});
	});
});
...
// Author: Realazy
// http://www.realazy.org/projects/tagto/index.html
